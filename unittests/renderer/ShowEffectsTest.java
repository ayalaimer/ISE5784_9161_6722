    ...
    public void ShowEffects() {
        ...
        scene.geometries.add(
                new Sphere(new Point(0, 0, -50), 25d)
                        ...
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30).setKt(0.3).setKr(0.3)),
                ...
                new Sphere(new Point(100, 100, -300), 75d)
                        ...
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(50).setKt(0.3).setKr(0.3)),
