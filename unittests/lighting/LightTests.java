...
public class LightTests {
    ...
    /** First camera builder for some the of tests */
    private final Camera.Builder camera1                 = Camera.getBuilder()
            .setRayTracer(new SimpleRayTracer(scene1))
            .setLocation(new Point(0, 0, 1000))
            .setDirection(new Vector(0,0,-1), new Vector(0,1,0))
            .setVpSize(150, 150).setVpDistance(1000);
    /** Second camera builder for some the of tests */
    ...
    @Test
    public void trianglesDifferentColorsAndDirections() {
        // הוספת שני המשולשים לסצנה scene2
        scene2.geometries.add(triangle1, triangle2);

        // הוספת מקורות אור מסוגים שונים עם צבעים שונים וכיוונים שונים
        ...
        // הגדרת ה-ImageWriter עבור מצלמה camera2 והפקת התמונה
        camera2.setImageWriter(new ImageWriter("lightTrianglesDifferentColorsAndDirections", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
